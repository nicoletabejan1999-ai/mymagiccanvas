...
(function () {
  ...
  function sync(s) {
    ...
    // Keep the names visibly larger than the original configurator while
    // preserving each font's own scale correction.
    sheet.style.setProperty('--fs-names', (8.5 * font.scale).toFixed(2) + 'cqw');
